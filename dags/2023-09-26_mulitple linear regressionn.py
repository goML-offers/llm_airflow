# Define the DAG for the multi linear regression model:
...
dag = DAG('multi_linear_regression_pipeline', default_args=default_args, schedule_interval=None)
...
def train_model():
    ...
    #Trains the model
    # Code to train the model using multi linear regression algorithm
    pass
def evaluate_model():
    #Evaluates the model
