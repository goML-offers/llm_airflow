...
dag = DAG('polynominal_regression_pipeline', default_args=default_args, schedule_interval=None)
...
def train_model():
    ...
    #Trains the model
    # Code to train the model using polynominal regression algorithm
    pass
def evaluate_model():
    #Evaluates the model
