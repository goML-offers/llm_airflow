#Generate the Python code for an Apache Airflow DAG that creates a machine learning pipeline using the linear regression algorithm. The DAG should include the following tasks with appropriate dependencies.
...
dag = DAG('linear_regression_pipeline', default_args=default_args, schedule_interval=None)
...
def train_model():
    ...
    #Trains the model
    # Code to train the model using linear regression algorithm
    pass
